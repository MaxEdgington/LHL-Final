...
VALUES
  ...
  ('Technology Stack Selection', 'Choose front-end and back-end technologies, including programming languages and databases.', '2023-12-12', '2', 1, 1, 3),
  ('UI/UX Design', 'Create wireframes, mockups, and a visually appealing cat-themed interface.', '2023-12-13', '2', 2, 1, 1),
  ('Front-End Development', 'Develop the front-end using HTML, CSS, and JavaScript with relevant frameworks.', '2023-12-14', '3', 1, 1, 4),
  ('Back-End Development', 'Build server-side logic, implement authentication, and create APIs for key features.', '2023-12-15', '3', 2, 1, 6),
  ('Database Setup and Management', 'Design the database schema, set up the database server, and implement queries.', '2023-12-16', '3', 3, 1, 5),
  ...
  ('Content Creation', 'Generate and optimize text, images, and other media for the website pages.', '2023-12-16', '1', 1, 1, 3),
  ('User Registration and Login System', 'Implement user registration and login functionality with secure authentication.', '2023-12-21', '2', 3, 1, 1),
  ('E-commerce Functionality', 'Add e-commerce features, such as product listings and shopping cart functionality.', '2023-12-23', '1', 2, 1, 2),
  ('Mobile Responsiveness', 'Ensure the website is responsive and functions well on mobile devices.', '2023-12-25', '3', 4, 1, 4),
  ('Security Audit', 'Conduct a security audit to identify and address potential vulnerabilities and threats.', '2023-12-26', '1', 3, 1, 7),
  ('Performance Optimization', 'Optimize the website performance for faster loading and improved user experience.', '2023-12-27', '1', 4, 1, 5);
